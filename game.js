...
updateHP();
window.RACombat={startJdmEncounter(){resetBattle('jdm');document.body.classList.add('jdm-mode','jdm-battle');window.RAJDMImports?.layoutBattleActors?.()},message:say,simulateLoss(){if(!document.body.classList.contains('dev-enabled')||battleEncounter!=='jdm')return false;richHP=0;updateHP();return defeat()},snapshot(){return {richHP,enemyHP:ceoHP,battleEncounter,busy,battleOver}}};

(function(){
  ...
  const defaults={version:3,rich:{budget:100000,social:null,location:'LA',clout:'LOW'},world:{day:1,month:1,scene:'battle'},characters:{ceo_assistant_001:{met:true,stolen:false,vampire:false,cracked:false}},encounters:{ceo_prince:{defeated:false,completed:false}},phone:{learned:false}};

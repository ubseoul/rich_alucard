(function(){
 ...
 D({id:'A07',title:'BOBA AT THE GRAVE',lane:'dating',memoryType:'dating',start:'wake',nodes:{
  ...
  meet:{env:'boba_shop',actors:A=>({left:'rich',right:A.vars.person}),
 ...
 D({id:'A08',title:'FIRST SHIFT AT SLURP DYNASTY',lane:'money',memoryType:'money',start:'arrive',nodes:{
  ...
  hina:{env:'slurp',actors:{left:'rich',right:'okada',farRight:'hina'},
 ...
 D({id:'A10',title:'UNCLE SUNDAY & THE AGEGE BREAD',lane:'dragons',memoryType:'dragons',available:L=>!!L.dragon,testSetup:ctx=>{ctx.RADragon.adoptEgg();},start:'arrive',nodes:{
  ...
  pay:{lines:[S('uncle_sunday','…you would insult me like that? fine. FINE.'),N('he takes double, muttering, and hands it over like it costs him something bigger than money.')],
   fx:A=>{RALife.spend(24);},next:'settle'},
  melt:{lines:[R('call him uncle.'),S('uncle_sunday','…UNCLE?'),N('he melts. he tears the loaf in half. he adopts you on the spot.')],next:'settle'},
  settle:{enter:A=>{RALife.addItem('agege_bread',1);RALife.setFlag('uncleSundayMet',true);RARelations.meet('uncle_sunday','a10');},
 ...
 D({id:'A12',title:'FIRST CAST',lane:'dragons',memoryType:'dragons',available:L=>!!L.dragon?.hatched,
  ...
  start:'arrive',nodes:{
  arrive:{env:'pier',title:'SANTA MONICA PIER · NIGHT',actors:{left:'rich',right:'uncle_sunday'},
  ...
  react:{lines:[N('you hold the fish at arm\'s length, visibly suffering.'),R('i\'m not looking at it. tell me when it\'s gone.')],next:'mazda'},
  mazda:{lines:A=>RALife.dragon()?.hatched?[N('blueberry mazda swoops down and eats it off the line before you can react.'),S('uncle_sunday','…she has good form.')]:[N('you set it down carefully, like it might still hurt you.')],next:'end'},
 ...
 D({id:'A14',title:'OPEN MIC AT THE CATACOMB',lane:'music',memoryType:'music',start:'arrive',nodes:{
  ...
  crowd:{lines:[N('half the room is paying attention.')],
  ...
  tasha:{env:'catacomb',actors:{left:'rich',right:'tasha'},
 ...
 D({id:'SHOW',title:'A SHOW AT THE CATACOMB',lane:'music',repeatable:true,oncePerNight:true,memoryType:'music',available:L=>L.done('A14'),start:'crowd',nodes:{
  crowd:{env:'catacomb',actors:{left:'rich'},lines:[N('the catacomb. dryers thump through the ceiling, same as always.')],
 ...
 D({id:'A15',title:'IRON JAW',lane:'music',memoryType:'music',available:L=>L.done('A14'),
  ...
  win:{lines:[S('iron_jaw','…his final verse. about a capri sun. it almost works.'),N('you beat him. barely.'),S('iron_jaw','respect. real ones talk texture.')],
 ...
 D({id:'A16',title:'CAFÉ LAPTOP NIGHT',lane:'music',memoryType:'music',start:'arrive',nodes:{
  ...
  wispa2:{lines:[S('wispa','i\'ve haunted this outlet since 1987. you\'re the first person who plugged in something interesting.')],next:'end'},
